...
<h6 v-if="meal.strDrinkAlternative">
Bebida Alternativa {{ meal.strDrinkAlternative }}
</h6>

<h6 v-if="meal.strYoutube">
Video en Youtube: <a v-bind:href="meal.strYoutube" target="_blank"> {{ meal.strYoutube }}</a>
</h6>
